<?php
       ...
       ?>
       <?php $result = $database->getVender($page, $limit, $order, $direction, $search);?>
<!doctype html>
<html ⚡>
<head>
    ...
    <ul class="product-list">
      <li>
        ...
        <div class="product-info">
          <div class="product-name"><span><?php echo $produtos['nome']?></span></div>
          <div class="product-price"><span class="special-price">9 available</span> <span>R$<?php echo $produtos['preco']?></span></div>
        </div>
      </li>
