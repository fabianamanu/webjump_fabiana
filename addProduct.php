...
<header>
  <div class="go-menu">
    ...
    <a href="assets/dashboard.php" class="link-logo"><img src="assets/images/go-logo.png" alt="Welcome" width="69" height="430" /></a>
  </div>
  <div class="right-box">
...
<!-- Header -->
  ...
  <main class="content">
    ...
    <form action="functions/cadProdutos.php" method="POST">
      ...
      <div class="input-field">
        ...
        <select name="categoria"  multiple id="category" class="input-text">
         
          <option required><?php
											
											 
											$result_cat = "SELECT * FROM categoria ORDER BY 'categora'";
